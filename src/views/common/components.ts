...
function formSubmissionCard(submission: FormSubmissionType) {
  ...
  expanded.sub(() => actions.println(expanded.val().toString()));
  ...
  return tag.div(
    ...
    tag.div(
      ...
      trait.styleOnEvt(
        "mouseover",
        "backgroundColor",
        theme.formSubmissionCard.bgHover,
      ),
      trait.styleOnEvt(
        "mouseout",
        "backgroundColor",
        theme.formSubmissionCard.bg,
      ),
      ...
      tag.div(
        ...
        tag.div(
          trait.style("fontSize", "0.7em"),
          trait.style("opacity", "0.5"),
          trait.text(submission.id),
        ),
      ),
      // card status
      tag.div(
    ...
    tag.div(
      trait.style("padding", theme.formSubmissionCard.padding),
      trait.style("display", "flex", expanded.$test),
