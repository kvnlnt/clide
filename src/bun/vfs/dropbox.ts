/**
 * Dropbox provider stub (ticket 102): interface implementation that returns
...
const NOT_CONNECTED = "Dropbox not connected";

export class DropboxProvider implements VfsProvider {
  readonly id = "dropbox";
