...
> Media. All Rights Reserved. This software is proprietary. No part of it may be
> used, copied, modified, or distributed without the prior written consent of
> the Owner. See [LICENSE](LICENSE) for full terms.
...
2. **Fill it in** — Type into clean, labeled fields — CLIDE maps them to script
   arguments.
3. **See results inline** — Hit Send and watch output stream right into the
   card, ready to re-run.
...
- **Anything, anywhere** — Shell commands, SSH to remote hosts, HTTP APIs, and
  AI models all share one interface. Compose them however you like.
- **Simpler** — No servers to babysit, no YAML pipelines, no dashboards. A
  folder of scripts is your whole platform.
- **Auditable** — Plain-text scripts in version control and a full run history
  mean you can always see exactly what executed, when, and with which inputs.
- **Yours** — It runs on your machine, talks to your servers, and uses your
  models. Your tools, your data, your rules — nothing leaves unless you send it.

## Download

Desktop builds for **macOS**, **Windows**, and **Linux** are coming soon.

## Development

Building on CLIDE? See [DEVELOPMENT.md](DEVELOPMENT.md) for setup, HMR, project
structure, and the marketing-site generator.

## License

Proprietary — All Rights Reserved.

Copyright (c) 2026 Kevin Lint and Lint Trap Media. This software and its source
code are the exclusive, confidential property of Kevin Lint and Lint Trap Media.
No license or right to use, copy, modify, or distribute is granted except by
explicit prior written permission. See [LICENSE](LICENSE) for full terms.
